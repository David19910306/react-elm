...
class ConfirmOrder extends Component {
  ...
  render() {
    ...
    this.props.history.location.pathname.startsWith('/confirmOrder/chooseAddress')? <Route path='/confirmOrder/chooseAddress' component={Address}/>: <div className='confirm-order-page'>
