...
export default function withMessage(WrappedComponent){
  return class WithMessage extends Component{
    ...
    nodeValueChange = msg2 => {
      this.setState({msg2}, () => {
        this.state.msg1 !== '' && (this.state.msg2 !== 'male' && this.state.msg2 !== 'female') ? this.props.getAddress({mainAddress:this.state.msg1, subAddress:this.state.msg2}):
          this.props.getPersonMessage({name:this.state.msg1, sex:this.state.msg2})
      })
    }
